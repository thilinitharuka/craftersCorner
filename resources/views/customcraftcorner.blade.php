            ...
            <div class="craft-container">
                ...
                <div class="craft-main-content">
                    <div class="craft-input-area">
                        ...
                        <img id="imagePreview" src="{{asset('assets/img/upload.png')}}" alt="Your sketch will appear here"/>

                        <h3>Describe the Image</h3>
                        <textarea id="prompt" rows="4" placeholder="e.g.tote bag, real photo, studio background"></textarea>
                    ...
                    <div class="craft-output-area">
                        ...
                        <img id="resultImage" src="{{asset('assets/img/real.png')}}" alt="AI result will appear here"/>
                        <button id="sendBtn" onclick="sentToAdmin();" style="display: none;">Send</button>
{{--                        <button onclick="sentToAdmin();" class="btn btn-primary">Send</button>--}}
                    </div>
                </div>
            </div>
...
@section('script')
    <script>
        const API_URL = "https://f58647f7de63.ngrok-free.app/generate";
